...
path_to_credentials = './credentials/mole-app-331709-ee20541d0504.json' # with storage admin role


moles_classes = ['benign','malignant']
...
def split_data_into_class_folders(path_to_data, class_id):
    ...
    for path in imgs_paths:
        ...
        if basename.startswith(str(class_id) + '_'):
            ...
            path_to_save = os.path.join(path_to_data, moles_classes[class_id])
...
if __name__ == '__main__':
    ...
    path_to_train_data = '/Users/patrikszepesi/MachineLearning/ml2021/MoleDetector/data/train/'
    path_to_val_data = '/Users/patrikszepesi/MachineLearning/ml2021/MoleDetector/data/training/validation/'
    path_to_eval_data = '/Users/patrikszepesi/MachineLearning/ml2021/MoleDetector/data/test/'
    ...
    if list_blobs_switch:
        blobs = list_blobs('mole-data-bucket')
